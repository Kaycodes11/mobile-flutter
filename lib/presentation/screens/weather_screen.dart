...
class _WeatherScreenState extends State<WeatherScreen> {
  // initState() method called exactly once when the stateful widget added to "widgetTree" and it's best to do one-time initilization, clean up or any code that needs to run before building UI (i.e. before executing "build method")
  @override
  void initState() {
    super.initState();
    // so, here dispatching "WeatherFetched event"
